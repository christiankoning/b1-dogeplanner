                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4">
                        <div class="card bg-transparent px-4">
                            ...
                            <?php endif; ?>
                            <div class="py-2">
                                <a href="/betalen/betaald" class="btn btn-primary btn-bestellen">Bestel</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layout/user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\Phpstorm Code\b1-dogeplanner\resources\views/services.blade.php ENDPATH**/ ?>