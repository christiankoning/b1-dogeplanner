...
<?php $__env->startSection('content'); ?>
    <section class="walkCreateUpdateSection d-flex align-items-center py-5" id="plans">
        <div class="container text-light">
            ...
            <form action="<?php echo e(route('walk.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                            <input type="number" min="1" name="amount_dogs"
                                   class="form-control <?php $__errorArgs = ['amount_dogs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('amount_dogs')); ?>" placeholder="hoeveelheid honden">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('location')); ?>" placeholder="locatie">
                        </div>
                    </div>
...
<?php echo $__env->make('layout.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\Phpstorm Code\b1-dogeplanner\resources\views//walk/create.blade.php ENDPATH**/ ?>