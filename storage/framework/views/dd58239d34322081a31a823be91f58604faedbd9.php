    ...
    <div class="container">
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
            <ul class="navbar-nav ms-auto navbar-nav-scroll">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('adminproduct') ? 'active' : ''); ?>" href="<?php echo e(route('products.index')); ?>">Producten beheren</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row" data-aos="fade-right">
            ...
            <div class="col-lg-3 py-4 py-md-5">
                <div>
                    ...
                    <div class="d-flex align-items-center py-2">
                        <i class="fas fa-caret-right"></i>
                        <a href="<?php echo e(route('orders.index')); ?>"><p class="ms-3">Diensten</p></a>
                    </div>
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
