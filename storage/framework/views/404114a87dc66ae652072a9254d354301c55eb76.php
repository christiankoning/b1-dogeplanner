                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4">
                        <div class="card bg-transparent px-4">
                            <p class="py-2"><strong>No: </strong><?php echo e(++$i); ?></p>
                            <p class="py-2">
                            ...
                            <div class="py-2">
                                ...
                                <form action="<?php echo e(route('walks.destroy',$value->id)); ?>" method="POST">
                                    <a class="btn btn-info btn-walk" href="<?php echo e(route('walks.show',$value->id)); ?>">Bekijken</a>
                                    <a class="btn btn-primary btn-walk" href="<?php echo e(route('walks.edit',$value->id)); ?>">Aanpassen</a>
                                    <?php echo csrf_field(); ?>
