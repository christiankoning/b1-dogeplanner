    ...
    <section class="walkShowSection d-flex align-items-center py-5" id="plans">
        <div class="container text-light">
            ...
            <div class="pull-right pb-4">
                <a class="btn btn-succes" href="<?php echo e(route('walks.index')); ?>">Terug</a>
            </div>
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\Phpstorm Code\b1-dogeplanner\resources\views/admin/walks/show.blade.php ENDPATH**/ ?>