                    ...
                    <div class="testimonial-card bg-transparent px-4">
                        <form action="<?php echo e(route('register.custom')); ?>" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Naam" id="name" class="form-control" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Email" id="email_address" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" placeholder="06-12345678" pattern="[0-9]{2}-[0-9]{8}" id="telephone" class="form-control" name="telephone" value="<?php echo e(old('telephone')); ?>" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" placeholder="Straatnaam" id="street_name" class="form-control" name="street_name" value="<?php echo e(old('street_name')); ?>" required>
                                    <?php if($errors->has('street_name')): ?>
                                        <span class="text-danger"><?php echo e($errors->first('street_name')); ?></span>
                                    <?php endif; ?>
                                    <input type="text" placeholder="Huisnmr." id="house_number" class="form-control" name="house_number" value="<?php echo e(old('house_number')); ?>" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="1234AB" pattern="[0-9]{4}[A-z]{2}" id="postal_code" class="form-control" name="postal_code" value="<?php echo e(old('postal_code')); ?>" required>
