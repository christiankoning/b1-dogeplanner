...
<nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
    <div class="container">
        ...
        <!-- Image Logo -->
        <a class="logo-image" href="<?php echo e(route('admin')); ?>"><img src="<?php echo e(asset('extra/Dogeplanner.png')); ?>" alt="alternative"></a>

        <!-- Text Logo - Use this if you don't have a graphic logo -->
        <a class="logo-text" href="<?php echo e(route('admin')); ?>">Jamy's uitlaatservice</a>
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
            <ul class="navbar-nav ms-auto navbar-nav-scroll">
                <li class="nav-item">
                    <a class="nav-link<?php echo e(Request::is('adminhome') ? 'active' : ''); ?>" aria-current="page" href="<?php echo e(route('admin')); ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('adminuser') ? 'active' : ''); ?>" href="<?php echo e(route('user.index')); ?>">Gebruikers beheren</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('adminwalk') ? 'active' : ''); ?>" href="<?php echo e(route('walks.index')); ?>">Wandelingen beheren</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('adminpayment') ? 'active' : ''); ?>" href="#">Betalingen beheren</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>">Gebruiker modus</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="userDropdown dropdown-menu dropdown-menu-end animate slideIn" aria-labelledby="navbarDropdown">
                        ...
                        <a href="#" class="dropdown-item">Strippenkaart</a>
            ...
            <div class="col-lg-3 py-4 py-md-5">
                <div>
                    ...
                    <div class="d-flex align-items-center py-2">
                        ...
                        <a href="#about"><p class="ms-3">Over mij</p></a>
                    </div>
                    <div class="d-flex align-items-center py-2">
                        <i class="fas fa-caret-right"></i>
                        <a href="#"><p class="ms-3">Voordelen uitlaatservice</p></a>
                    </div>
                    <div class="d-flex align-items-center py-2">
                        <i class="fas fa-caret-right"></i>
                        <a href="#"><p class="ms-3">Tarieven</p></a>
                    </div>
                    <div class="d-flex align-items-center py-2">
                        <i class="fas fa-caret-right"></i>
...
<?php else: ?>
    ...
    <p class="errmsg"><b>403:</b>Unautorized</p>
    <hr>
    <p class="errormsg">When you look at the unauthorised page, be carefull, the admin looks back.</p>
</body>
<?php endif; ?>
<?php /**PATH M:\Phpstorm Code\b1-dogeplanner\resources\views/layout/admin.blade.php ENDPATH**/ ?>