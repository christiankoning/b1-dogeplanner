...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/datepicker-nl.js') }}"></script>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('extra/Dogeplanner.png') }}">
...
<nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
    <div class="container">
        ...
        <!-- Image Logo -->
        <a class="logo-image" href="/"><img src="{{asset('extra/Dogeplanner.png')}}" alt="alternative"></a>
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
            <ul class="navbar-nav ms-auto navbar-nav-scroll">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('aboutme')}}">Over mij</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('benefits')}}">Voordelen uitlaatservice</a>
                </li>
                <li class="nav-item">
                ...
                @guest
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register-user') }}">Registreren</a>
                        </li>
                    @else
