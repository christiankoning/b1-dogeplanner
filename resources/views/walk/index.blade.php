    ...
    <section class="walkIndexSection d-flex align-items-center py-5" id="plans">
        <div class="container text-light">
            ...
            <div class="pull-right pb-4">
                <a class="btn btn-succes" href="{{route('walk.create')}}">Wandeling aanmaken</a>
            </div>
            ...
            <div class="row gy-4" data-aos="zoom-in">
                        ...
                        <div class="col-lg-4">
                            <div class="card bg-transparent px-4">
                                ...
                                <div class="py-2">
                                    ...
                                    <form action="{{ route('walk.destroy',$value->id) }}" method="POST">
                                        <a class="btn btn-info btn-walk" href="{{ route('walk.show',$value->id) }}">Bekijken</a>
                                        @csrf
                                        @method('DELETE')
                ...
                @if(count($pendingWalks) > 0)
                        ...
                        <div class="col-lg-4">
                            <div class="card bg-transparent px-4">
                                ...
                                <div class="py-2">
                                    ...
                                    <form action="{{ route('walk.destroy',$value->id) }}" method="POST">
                                        <a class="btn btn-info btn-walk" href="{{ route('walk.show',$value->id) }}">Bekijken</a>
                                        <a class="btn btn-primary btn-walk" href="{{ route('walk.edit',$value->id) }}">Aanpassen</a>
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-walk">Verwijderen</button>
                                    </form>
                    ...
                    @endforeach
                @endif
                @if(count($deniedWalks) > 0)
                    <h2>Afgewezen</h2>
                    @foreach ($deniedWalks as $key => $value)
                        <div class="col-lg-4">
                            <div class="card bg-transparent px-4">
                                <p class="py-2"><strong>No: </strong>{{$value->id}}</p>
                                <p class="py-2">
